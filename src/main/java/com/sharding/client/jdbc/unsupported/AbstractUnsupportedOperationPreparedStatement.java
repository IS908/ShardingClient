 ...
 * @author zhangliang
 */
public abstract class AbstractUnsupportedOperationPreparedStatement extends BaseDDFProxy implements PreparedStatement {

    public AbstractUnsupportedOperationPreparedStatement() {

    }

    public AbstractUnsupportedOperationPreparedStatement(Map<String, Object> attributeMap) {
        super(attributeMap);
    }
