 ...
 * @author zhangliang
 */
public abstract class AbstractUnsupportedUpdateOperationResultSet extends BaseDDFProxy implements ResultSet {

    public AbstractUnsupportedUpdateOperationResultSet(Map<String, Object> attributeMap) {
        super(attributeMap);
    }
